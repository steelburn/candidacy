...
class ConfigurationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            // New AI Providers (Multi-Provider Support)
            [
            ...
            [
                'key' => 'ai.litellm.api_key',
                'value' => '',
                'type' => 'string',
                'category' => 'ai',
                'description' => 'LiteLLM API key (optional)',
                'is_public' => false,
                'is_sensitive' => true,
                'service_scope' => 'ai-service',
                'requires_restart' => false,
